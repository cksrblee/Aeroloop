...
# Test 1: Executable
print("Trying with executable...")
vsp.SetVSPAEROPath("/root/projects/AeroLoop/thirdparty/build_openvsp/OpenVSP-prefix/src/OpenVSP-build/python_pseudo/openvsp/openvsp/vspaero")
